...
<TR>
<td>
<%@ include file="index21.jsp"%></td>
<td>
<table>
<tr>
<td>
<h3> At the moment you are logged as: <% out.print(session.getAttribute("currentSessionUser")); %></h3>
</td>
</tr>
<tr>
...
Username</td>
<td>
 <% out.print(session.getAttribute("currentSessionUser")); %></td>
</tr>
<tr>
<td>
Mail</td>
...
<td>
<% 
rs = stmt.executeQuery("SELECT * FROM member where login like '"+user+"'");
String www = "";
while ( rs.next() ) {
